	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (pagecode.equals("file")) {
			...
			String uploadDir = Paths
					.get(userHome, "Desktop", "webGame", "project", "webGame", "src", "main", "webapp", "webGL")
					.toString();
			String uploadImgDir = Paths.get(userHome, "Desktop", "webGame", "project", "webGame", "src", "main",
					"webapp", "img", "gameLogo").toString();
